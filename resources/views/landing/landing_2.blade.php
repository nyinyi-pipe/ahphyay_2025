...
<head>
    ...
    <!--=== Font-Awesome CSS ===-->
    <link href="bootstrap/css/vendor/font-awesome.css" rel="stylesheet">
    <!--=== Plugins CSS ===-->
        ...
        <div class="row">
            ...
            <div class="col-3 col-lg-1 col-xl-2 m-auto">
                <a href="index.html" class="logo-area">
                    <img src="bootstrap/img/logo.png" alt="Logo" class="img-fluid"/>
                </a>
            </div>
            <!-- Logo Area End -->
                        ...
                        <li class="shop-cart"><a href="#"><i class="fa fa-shopping-bag"></i> <span
                            ...
                            <div class="mini-cart">
                                <div class="mini-cart-body">
                                    ...
                                    <div class="single-cart-item d-flex">
                                        <figure class="product-thumb">
                                            <a href="#"><img class="img-fluid" src="bootstrap/img/product-3.jpg"
                                                             alt="Products"/></a>
                                        </figure>
                                        <div class="product-details">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="about-image-wrap">
                    <a href="about.html"><img src="bootstrap/img/about-img.png" alt="About Us" class="img-fluid"/></a>
                </div>
                            ...
                            <div class="products-wrapper">
                                <div class="products-carousel owl-carousel">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.html"><img src="bootstrap/img/product-1.jpg"
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.html"><img src="bootstrap/img/product-2.jpg"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.html"><img src="bootstrap/img/product-3.jpg"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.html"><img src="bootstrap/img/product-4.jpg"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>
                        ...
                        <div class="tab-pane fade" id="new-products" role="tabpanel" aria-labelledby="new-products-tab">
                            <div class="products-wrapper">
                                <div class="products-carousel owl-carousel">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.html"><img src="bootstrap/img/new-product-1.jpg"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.html"><img src="bootstrap/img/new-product-2.jpg"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.html"><img src="bootstrap/img/new-product-3.jpg"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.html"><img src="bootstrap/img/new-product-4.jpg"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>
                        ...
                        <div class="tab-pane fade" id="onsale" role="tabpanel" aria-labelledby="onsale-tab">
                            <div class="products-wrapper">
                                <div class="products-carousel owl-carousel">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.html"><img src="bootstrap/img/sale-product-1.jpg"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.html"><img src="bootstrap/img/sale-product-2.jpg"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>
                ...
                <div class="large-size-cate">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="single-cat-item">
                                <figure class="category-thumb">
                                    <a href="#"><img src="bootstrap/img/women-cat.jpg" alt="Women Category"
                                                     class="img-fluid"/></a>
                        ...
                        <div class="col-sm-6">
                            <div class="single-cat-item">
                                <figure class="category-thumb">
                                    <a href="#"><img src="bootstrap/img/men-cat.jpg" alt="Men Category" class="img-fluid"/></a>
            ...
            <div class="col-lg-12">
                <div class="products-wrapper">
                    <div class="new-products-carousel owl-carousel">
                        ...
                        <div class="single-product-item text-center">
                            <figure class="product-thumb">
                                <a href="single-product.html"><img src="bootstrap/img/new-product-1.jpg" alt="Products"
                                                                   class="img-fluid"></a>
                            </figure>
                        ...
                        <div class="single-product-item text-center">
                            <figure class="product-thumb">
                                <a href="single-product.html"><img src="bootstrap/img/new-product-2.jpg" alt="Products"
                                                                   class="img-fluid"></a>
                            </figure>
                        ...
                        <div class="single-product-item text-center">
                            <figure class="product-thumb">
                                <a href="single-product.html"><img src="bootstrap/img/new-product-3.jpg" alt="Products"
                                                                   class="img-fluid"></a>
                            </figure>
                        ...
                        <div class="single-product-item text-center">
                            <figure class="product-thumb">
                                <a href="single-product.html"><img src="bootstrap/img/new-product-4.jpg" alt="Products"
                                                                   class="img-fluid"></a>
                            </figure>
        ...
        <div class="row">
            <div class="col-lg-8 m-auto">
                <div class="newsletter-form-wrap">
                    <form id="subscribe-form" action="https://d29u17ylf1ylz9.cloudfront.net/ruby-v2/ruby/bootstrap/php/subscribe.php" method="post">
            ...
            <div class="callto-action-wrapper">
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="single-callto-action d-flex">
                            <figure class="callto-thumb">
                                <img src="bootstrap/img/air-plane.png" alt="WorldWide Shipping"/>
                            </figure>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="single-callto-action d-flex">
                            <figure class="callto-thumb">
                                <img src="bootstrap/img/support.png" alt="Support"/>
                            </figure>
                            <div class="callto-info">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="single-callto-action d-flex">
                            <figure class="callto-thumb">
                                <img src="bootstrap/img/money-back.png" alt="Money Back"/>
                            </figure>
                            <div class="callto-info">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="single-callto-action d-flex">
                            <figure class="callto-thumb">
                                <img src="bootstrap/img/cog.png" alt="Guide"/>
                            </figure>
                            <div class="callto-info">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <div class="follow-content-wrap">
                            <a href="index.html" class="logo"><img src="bootstrap/img/logo.png" alt="logo"/></a>
                            <p>Eodem modo typi, qui nunc nobis videntur parum clari, fiant sollemnes in futurum</p>
                            ...
                            <a href="#"><img src="bootstrap/img/payment.png" alt="Payment Method"/></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="imgage-gallery-carousel owl-carousel">
                            <div class="gallery-item">
                                <a href="#"><img src="bootstrap/img/gallery-img-1.jpg" alt="Gallery"/></a>
                            </div>
                            <div class="gallery-item">
                                <a href="#"><img src="bootstrap/img/gallery-img-2.jpg" alt="Gallery"/></a>
                            </div>
                            <div class="gallery-item">
                                <a href="#"><img src="bootstrap/img/gallery-img-3.jpg" alt="Gallery"/></a>
                            </div>
                            <div class="gallery-item">
                                <a href="#"><img src="bootstrap/img/gallery-img-4.jpg" alt="Gallery"/></a>
                            </div>
                            <div class="gallery-item">
                                <a href="#"><img src="bootstrap/img/gallery-img-3.jpg" alt="Gallery"/></a>
                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true"><img src="bootstrap/img/cancel.png" alt="Close" class="img-fluid"/></span>
            </button>
                                ...
                                <div class="product-thumb-carousel owl-carousel">
                                    <div class="single-thumb-item">
                                        <a href="single-product.html"><img class="img-fluid"
                                                                           src="bootstrap/img/single-pro-thumb.jpg"
                                                                           alt="Product"/></a>
                                    </div>

                                    <div class="single-thumb-item">
                                        <a href="single-product.html"><img class="img-fluid"
                                                                           src="bootstrap/img/single-pro-thumb-2.jpg"
                                                                           alt="Product"/></a>
                                    </div>

                                    <div class="single-thumb-item">
                                        <a href="single-product.html"><img class="img-fluid"
                                                                           src="bootstrap/img/single-pro-thumb-3.jpg"
                                                                           alt="Product"/></a>
                                    </div>

                                    <div class="single-thumb-item">
                                        <a href="single-product.html"><img class="img-fluid"
                                                                           src="bootstrap/img/single-pro-thumb-4.jpg"
                                                                           alt="Product"/></a>
                                    </div>
                                </div>
                            </div>
